...
\begin{ulohav}
Na pružině je zavěšeno závaží, které kmitá nahoru a dolů tak, že vzdálenost nejvyššího a nejnižšího bodu je 10\,cm. Jeden celý kmit (z nejnižší pozice úplně nahoru\,+\, zpátky úplně dolů, tj. jedna perioda) trvá 1\,s. V čase $t = 0$ se závaží nacházelo přesně uprostřed a pohybovalo se směrem nahoru.
\begin{enumerate}
